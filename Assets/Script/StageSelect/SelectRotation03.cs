...
public class SelectRotation03 : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        CubePosition01 = CubePosition[2];
        CubePosition02 = CubePosition[3];
        ...
        g_Text05 = GameObject.Find("Text05");
        g_Text06 = GameObject.Find("Text06");
    ...
    void Update()
    {
        switch (p_Phase)
        {
            case 0:
                if (Input.GetKey(KeyCode.RightArrow))
                {
                    ...
                    {
                        sound S03 = SelectSE.GetComponent<sound>();
                        S03.Sound01();
                    }
        ...
        if (iPos == 0)
        {
            g_Text05.GetComponent<Text>().enabled = true;
            g_Text06.GetComponent<Text>().enabled = true;
        }
        else
        {
            g_Text05.GetComponent<Text>().enabled = false;
            g_Text06.GetComponent<Text>().enabled = false;
        }
    }
}
